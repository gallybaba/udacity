...
def decision_step(Rover):
    ...
    if is_clear(Rover):
        ...
        print('decision not clear found unstucking')
        Rover = unstuck(Rover)
...
def handle_sample_in_vision(Rover):
    if Rover.is_sample_in_vision == True and is_clear(Rover):
        Rover.throttle = 0.5
        ...
        print('sample in vision not clear')
        Rover = unstuck(Rover)
